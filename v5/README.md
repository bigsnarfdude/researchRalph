...
| `guard-preflight.sh` | 16-test suite (hash, scanner, contamination, gate reproduce/forge/trace-violation, loop halt) — $0 |
...
Status 2026-07-22: guard-preflight 16/16, loop-preflight 16/16 + island-preflight
