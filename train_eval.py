...
def train_probe(ProbeClass, X_train, y_train, X_val, y_val, epochs=200, lr=1e-3):
...
def main():
    ...
    results = {
        ...
        "baseline_test_auroc": 0.72,
        "delta_vs_baseline": round(test_auroc - 0.72, 4),
    ...
    print(f"  Delta:      {test_auroc - 0.72:+.4f} vs baseline")
