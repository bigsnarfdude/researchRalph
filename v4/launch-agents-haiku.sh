...
" 2>/dev/null)
    ...
    screen -dmS "$SESSION" bash -c "
        ...
        claude --model haiku --output-format stream-json --verbose \
...
echo "  screen -r rrma-haiku-w0              # attach to worker 0"
echo "  screen -r rrma-haiku-meta                 # attach to meta-agent"
