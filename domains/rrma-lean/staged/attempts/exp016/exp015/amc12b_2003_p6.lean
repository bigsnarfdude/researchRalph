...
theorem amc12b_2003_p6 (a r : ℝ) (u : ℕ → ℝ) (h₀ : ∀ k, u k = a * r ^ k) (h₁ : u 1 = 2)
  ...
  -- r² = 3
  have hr_ne : r ≠ 0 := by
    intro hr; rw [hr, mul_zero] at har; linarith
  have ha_ne : a ≠ 0 := by
    intro ha; rw [ha, zero_mul] at har; linarith
  have hr2 : r ^ 2 = 3 := by
  ...
  have target_sq : (2 / Real.sqrt 3) ^ 2 = 4 / 3 := by
    rw [div_pow, hsqrt3_sq]; norm_num
  -- a² = (2/√3)² → a = 2/√3 or a = -(2/√3)
