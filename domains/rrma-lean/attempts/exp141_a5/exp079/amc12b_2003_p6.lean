...
theorem amc12b_2003_p6 (a r : ℝ) (u : ℕ → ℝ) (h₀ : ∀ k, u k = a * r ^ k) (h₁ : u 1 = 2)
  ...
  have hr2 : r ^ 2 = 3 := by
    have h_eq : a * r * r ^ 2 = a * r ^ 3 := by ring
    rw [har, har3] at h_eq; linarith
  have ha2 : a ^ 2 = 4 / 3 := by
    have h_eq : (a * r) ^ 2 = a ^ 2 * r ^ 2 := by ring
    rw [har, hr2] at h_eq; linarith
  ...
  have h1 : a ^ 2 - (2 / Real.sqrt 3) ^ 2 = 0 := by rw [target_sq]; linarith
  have h2 : (a - 2 / Real.sqrt 3) * (a + 2 / Real.sqrt 3) = 0 := by nlinarith [h1]
