...
theorem aime_1997_p11 (x : ℝ)
  ...
  try
  have hb : 1 ≤ 10 := by nlinarith [h₀]
  interval_cases 1 <;> omega
  try
  have hb : 1 ≤ 10 := by nlinarith [h₀]
  interval_cases 1 <;> simp_all <;> omega
  try
  have hb : 1 ≤ 20 := by nlinarith [h₀]
  interval_cases 1 <;> omega
  try
  have hb : 1 ≤ 20 := by nlinarith [h₀]
  interval_cases 1 <;> simp_all <;> omega
  try
  have hb : 1 ≤ 50 := by nlinarith [h₀]
  interval_cases 1 <;> omega
  try
  have hb : 1 ≤ 50 := by nlinarith [h₀]
  interval_cases 1 <;> simp_all <;> omega
  try
  have hb : 1 ≤ 100 := by nlinarith [h₀]
  interval_cases 1 <;> omega
  try
  have hb : 1 ≤ 100 := by nlinarith [h₀]
  interval_cases 1 <;> simp_all <;> omega
