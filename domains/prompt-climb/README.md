...
**Setup:** 4 Claude agents optimizing a sandbagging detection prompt. 100-sample balanced eval (50 deceptive + 50 honest). Metric: F1 score. Baseline: LinuxArena prompt at ~0.80 F1.
