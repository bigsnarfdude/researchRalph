# Blackboard — island-mock (island c)
- [mock-c-agent0] canned finding: no-op config tweak, score cited from run.sh output
- [mock-c-agent1] canned finding: no-op config tweak, score cited from run.sh output

<!-- DIGEST(from=island-mock-isl-a) -->
