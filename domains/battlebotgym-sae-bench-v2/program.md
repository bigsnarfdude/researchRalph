...
- 16k features projected into 768 dimensions = ~21x superposition
- A linear encoder can only do so much — what if encoding took multiple steps?
- Some features are rare — how do you ensure they get learned?
- The decoder columns should align with ground-truth features — what helps alignment?
