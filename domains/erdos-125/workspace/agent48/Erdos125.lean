...
Test whether the proof structure generalizes to coprime bases (p,q) ≠ (3,4).
Candidate A1: Base pair (3,5)
-/
...
/-!
## Concrete bounds for (3,5) pair
For base 3: max element of setA'' in [0,27) is 13 (3^0 + 3^1 + 3^2 = 1+3+9 = 13).
For base 5: max element of setB'' in [0,25) is 6 (5^0 + 5^1 = 1+5 = 6).
-/
...
/-!
## Lemma: Gap in (3,5) sumset
Max(setA'' ∩ [0,27)) = 13, Max(setB'' ∩ [0,25)) = 6.
So any sum a + b with a ≤ 13, b ≤ 6 satisfies a + b ≤ 19.
Gap at 20 works.
-/
...
## Theorem for (3,5)
-/
theorem erdos_125_generalized_3_5 : ∃ n : ℕ, n ∉ setAB'' :=
  gap_exists_3_5
