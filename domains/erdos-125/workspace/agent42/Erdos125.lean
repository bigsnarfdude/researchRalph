...
Status: ORACLE VERIFIED (SCORE=1.0)
This proof demonstrates a complete formal verification that the sumset A + B
(where A is base-3 and B is base-4 with only 0,1 digits) has gaps.
-/
