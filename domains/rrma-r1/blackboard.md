...
## Open questions
- What is the right sampling strategy? (1 sample? N samples? How to aggregate?)
- How to make the reward signal low-variance enough for stable learning?
- Does the model need to "try and fail" to learn, or just see correct examples?
- Is the bottleneck exploration or credit assignment?
